        ...
        {showInfo && hasPackageInfo && (
          ...
          >
            ...
            <div className="h-full overflow-y-auto p-6 md:p-8 pt-16">
              {/* Tour Title */}
              <h4 className="text-2xl md:text-3xl font-black text-slate-900 mb-3 tracking-tight">
                {tour.title}
              </h4>
              ...
              {tour.packageName && (
                <div className="mb-4">
                  <span className="inline-block px-3 py-1.5 bg-gradient-to-r from-cyan-500 to-teal-500 text-white rounded-full text-xs font-bold uppercase tracking-wide shadow-sm">
                    {tour.packageName}
                  </span>
                </div>
              )}
                ...
                <div className="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-slate-200">
                  {tour.packagePrice && (
                    <div className="flex items-baseline gap-1.5">
                      <span className="text-3xl md:text-4xl font-black bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent">
                        {tour.packagePrice}
                      </span>
                    </div>
                  )}
                  {tour.packageDuration && (
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-cyan-50 rounded-lg border border-cyan-100">
                      ...
                      <span className="text-sm font-bold text-cyan-700">{tour.packageDuration}</span>
                    </div>
                  )}
                </div>
              )}
              ...
              {tour.packageIncludes && tour.packageIncludes.length > 0 && (
                <div className="mb-6">
                  <h5 className="text-xs font-black text-slate-400 uppercase tracking-wider mb-3">Incluye:</h5>
                  <div className="space-y-2">
                    {tour.packageIncludes.map((item, i) => (
                      <div key={i} className="flex items-start gap-3 p-3 bg-white rounded-xl border border-slate-100 hover:border-cyan-200 hover:bg-cyan-50/50 transition-all">
                        <div className="flex-shrink-0 w-5 h-5 rounded-full bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center mt-0.5">
              ...
              <a
                ...
                onClick={(e) => e.stopPropagation()}
                className="sticky bottom-0 w-full px-6 py-4 bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 text-white rounded-xl md:rounded-2xl font-bold text-base shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 group/btn"
              >
