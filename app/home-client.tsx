    ...
    <Link href={`/tours/${tour.id}`}>
      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-4 md:p-6">
        ...
        <motion.div
          ...
          className="mt-4"
        >
          <div className="inline-flex items-center gap-2 px-4 py-2.5 bg-white/90 backdrop-blur-sm hover:bg-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl group/btn">
            <span className="text-sm font-bold text-slate-900">Conocer más</span>
            <svg className="w-4 h-4 text-slate-900 transition-transform group-hover/btn:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
