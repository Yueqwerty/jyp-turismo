            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-4 gap-3 pt-4">
                  <div className="p-3 bg-green-50 rounded-xl flex flex-col items-center gap-1">
                    ...
                    <div className="text-[10px] font-bold text-green-900">WhatsApp</div>
                  </div>
                  {content.heroSection.facebookUrl && (
                    <div className="p-3 bg-blue-50 rounded-xl flex flex-col items-center gap-1">
                      <svg className="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                      </svg>
                      <div className="text-[10px] font-bold text-blue-900">Facebook</div>
                    </div>
                  )}
                  {content.heroSection.instagramUrl && (
                    <div className="p-3 bg-pink-50 rounded-xl flex flex-col items-center gap-1">
